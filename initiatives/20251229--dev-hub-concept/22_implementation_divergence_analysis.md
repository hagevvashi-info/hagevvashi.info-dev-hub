...
```json
"workspaceFolder": "/home/hagevvashi"
```

#### 影響

- ❌ VS Codeで開いた際のルートディレクトリが `/home/hagevvashi` になる
...
```json
"mounts": [
  "source=/Users/hagevvashi/.bash_history,target=/home/hagevvashi/.bash_history,type=bind,consistency=cached",
  "source=/Users/hagevvashi/.git,target=/home/hagevvashi/.git,type=bind,consistency=cached",
  ...
...
VS Code DevContainerのデフォルト挙動では、`${localWorkspaceFolder}` が `/workspaces/<リポジトリ名>` にマウントされることが多いです。しかし、現在の設定では `workspaceFolder: /home/hagevvashi` となっているため、実際のマウント先を確認する必要があります。
...
```json
"mounts": [
  "source=/Users/hagevvashi/.ssh,target=/home/hagevvashi/.ssh,type=bind,consistency=cached",
  "source=/Users/hagevvashi/.gitconfig,target=/home/hagevvashi/.gitconfig,type=bind,consistency=cached",
  "source=/Users/hagevvashi/.aws,target=/home/hagevvashi/.aws,type=bind,consistency=cached",
  ...
]
```
...
```bash
$ ls -la /Users/hagevvashi/hagevvashi.info-dev-hub/
...
- `workspaceFolder`: `/home/hagevvashi/hagevvashi.info-dev-hub` ✅
- `postCreateCommand`: `bash /home/hagevvashi/hagevvashi.info-dev-hub/.devcontainer/post-create.sh` ✅
- `REPO_NAME`: `hagevvashi.info-dev-hub` ✅
- Docker Volume `repos` のマウント先: `/home/hagevvashi/hagevvashi.info-dev-hub/repos` ✅
